...
<head>
    ...
    <title>Forgot Password - African Pharmaceutical Review</title>
...
<body>
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            submitBtn.innerHTML = '<span class="loading active"><i class="fas fa-spinner fa-spin"></i></span> Sending reset link...';
        });
