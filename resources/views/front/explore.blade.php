                        ...
                        <div class="blog-details-wrap">
                                ...
                                <div class="blog-details-content-top">
                                    ...
                                    <div class="bd-content-inner">
                                        <div class="blog-post-meta">
                                            <ul class="list-wrap">
                                                <li><i class="flaticon-user"></i>by<a href="author.html">{{$content->author}}</a></li>
                            ...
                            <div class="blog-avatar-wrap mb-50">
                                ...
                                <div class="blog-avatar-info">
                                    ...
                                    <p>Author BioFinanappreciate your trust greatly Our clients choose dentace ducts because kneer ow we are the best area Awaitingare really.</p>
                                </div>
                            </div>
                            <?php
                              $Current = $content->id;
                    ...
                    <div class="col-30">
                        <div class="sidebar-wrap">
                            ...
                            <div class="sidebar-widget sidebar-widget-two">
                                ...
                                <?php
                                    $Recent = DB::table('blogs')->where('type','News')->OrderBy('created_at', 'desc')->limit('4')->get();
                                ?>
                                <div class="hot-post-wrap">
                                    @foreach ($Recent as $recent)
                                    <div class="hot-post-item">
                                        <div class="hot-post-thumb">
                                            <a href="{{url('/')}}/{{$recent->type}}/{{$recent->slung}}"><img src="{{$recent->image_one}}" alt=""></a>
                                        </div>
                                        <div class="hot-post-content">
                                            <a href="blog.html" class="post-tag">Adventure</a>
                                            <h4 class="post-title"><a href="{{url('/')}}/{{$recent->type}}/{{$recent->slung}}">{{$recent->title}}</a></h4>
                                            <div class="blog-post-meta">
                                                <ul class="list-wrap">
                                                    <li><i class="flaticon-calendar"></i>{{date('d M, Y', strtotime($recent->created_at))}}</li>
