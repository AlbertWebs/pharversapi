  ...
  <table border="0" width="600" cellpadding="0" cellspacing="0" align="center" style="width:600px; margin: auto;" class="email-container">
    <tr>
      <td>
        ...
        <!-- Logo + Links : BEGIN -->
        <table border="0" width="100%" cellpadding="0" cellspacing="0" style="background-color:#12253E">
          ...
          <tr>
            <td valign="middle" width="80" style="padding:5px 0; text-align:center; line-height: 0;" class="stack-column-center">
              <a href="https://droplr.com">
                <img src="{{url('/')}}/uploads/logo/log.png" alt="Droplr Logo" width="180"  border="0" style="margin: auto;">
              </a>
            </td>
          </tr>
          <tr><td height="5" style="font-size: 0; line-height: 0;">&nbsp;</td></tr>
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
          ...
          <tr>
            <td style="padding: 4%; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; text-rendering: optimizeLegibility; -webkit-font-smoothing: antialiased;line-height: 26px; color: #5a6066;">
                <div>
                    Thank you for subscribing to African Pharmaceutical Reviews updates! We're thrilled to have you join our community. To ensure you get the most out of our updates and personalized content, please take a moment to complete your profile.
                    <br><br>
                    Simply go to <a href="https://africanpharmaceuticalreview.com/login">this link</a>, log in using your email address and 'email' as your temporary password, and update your profile with your preferences and interests. This will help us tailor our content to better meet your needs.
                    <br><br>
                    We look forward to keeping you informed with the latest reviews, insights, and developments in the African pharmaceutical industry. Welcome aboard!
                  </div>
    ...
    <tr>
      <td valign="middle" width="80" style="padding: 16px 0; text-align:center; line-height: 0; border-top: 1px solid #ebedf0;" class="stack-column-center">
        <a href="https://droplr.com">
          {{-- <img src="http://bernar.d.pr/1bCcI+" alt="Droplr Logo" width="80" height="26" border="0" style="margin: auto;"> --}}
        </a>
      </td>
    </tr>
    <tr>
      <td style="text-align:center; padding: 0 0 16px 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; text-rendering: optimizeLegibility; -webkit-font-smoothing: antialiased;line-height: 26px; color: #5a6066;">
        <span class="mobile-link--footer">African Pharmaceutics Review</span>
        <br>
      </td>
    </tr>
