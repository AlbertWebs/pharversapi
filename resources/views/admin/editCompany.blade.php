...
<div class="p-6">
    ...
    <nav class="mb-6">
        <ol class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li><i class="fas fa-chevron-right text-gray-400"></i></li>
            <li class="text-gray-900 font-medium">Edit Company</li>
        </ol>
    </nav>
    ...
    <div class="admin-card-modern animate-fade-in">
        <form method="POST" action="{{url('/')}}/admin/edit_Company/{{$Company->id}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-8">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="article-ckeditor" 
                              ...
                              placeholder="Write a detailed description about the company...">{{$Company->content}}</textarea>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="logo_cheat" value="{{$Company->logo}}">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            @if($Company->favicon)
                                <div class="mb-4">
                                    ...
                                    <img src="{{(substr($Company->favicon, 0, 4) === 'http') ? $Company->favicon : url('/') . '/uploads/companies/' . basename($Company->favicon)}}" 
                                         alt="Current favicon" 
                                         id="favicon-preview"
                        ...
                        <input type="hidden" name="favicon_cheat" value="{{$Company->favicon}}">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            @if($Company->image)
                                <div class="mb-4">
                                    ...
                                    <img src="{{(substr($Company->image, 0, 4) === 'http') ? $Company->image : url('/') . '/uploads/companies/' . basename($Company->image)}}" 
                                         alt="Current banner" 
                                         id="banner-preview"
                                         class="max-w-full h-auto max-h-32 object-contain rounded-lg border border-gray-200 shadow-sm">
                                </div>
                        ...
                        <input type="hidden" name="image_cheat" value="{{$Company->image}}">
                    </div>
                </div>
            </div>
