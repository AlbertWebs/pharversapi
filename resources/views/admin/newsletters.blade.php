        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Available Issues</a>
                    </li>
                    <li class="page-back"><a href="{{url('/')}}/admin/addNewsLetter"><i class="fa fa-pencil" aria-hidden="true"></i> Add Newsletter </a>
                    </li>
                </ul>
            </div>
            <div class="sb2-2-1">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('/')}}/admin/editNewsletters/{{$item->id}}" class="sb2-2-1-edit">
