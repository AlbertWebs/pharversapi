...
<div class="p-6">
    ...
    <nav class="mb-6">
        <ol class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li class="text-gray-900 font-medium">All Products</li>
            <li class="ml-auto">
                <a href="{{url('/')}}/admin/addProduct" class="admin-btn admin-btn-primary">
            ...
            <table class="admin-table">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('/')}}/product/{{$item->slung}}" target="_blank" class="text-primary-600 hover:text-primary-700 font-medium">
                                {{$item->name}}
                            </a>
                        </td>
                        <td>
                        ...
                        <td>
                            <a href="{{url('/')}}/product/{{$item->slung}}" target="_blank">
