        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="page-back"><a href="{{url('/')}}/manager/dashboard/home"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                    </li>
                </ul>
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                <div class="box-inn-sp">
                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/manager/dashboard/edit_Blog/{{$Blog->id}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
