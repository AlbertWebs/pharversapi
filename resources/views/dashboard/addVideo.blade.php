...
<div class="p-6">
    ...
    <nav class="mb-6">
        <ol class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li><i class="fas fa-chevron-right text-gray-400"></i></li>
            <li class="text-gray-900 font-medium">Add Video</li>
        </ol>
    </nav>
    
    <!-- Page Header -->
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Add New Video</h2>
        <p class="text-gray-600 mt-1">Add a new video post</p>
    </div>
    
    <!-- Form -->
    <div class="admin-card-modern animate-fade-in">
        <form method="POST" action="{{url('/')}}/manager/dashboard/add_Video" enctype="multipart/form-data">
