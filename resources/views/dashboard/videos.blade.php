...
<div class="p-6">
    ...
    <nav class="mb-6">
        <ol class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li class="text-gray-900 font-medium">Videos</li>
            <li class="ml-auto">
                <a href="{{url('/')}}/manager/dashboard/addVideo" class="admin-btn admin-btn-primary">
    ...
    <div class="admin-card-modern animate-fade-in">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center space-x-2">
                                <a href="{{url('/')}}/manager/dashboard/editVideo/{{$item->id}}" 
        ...
        <div class="text-center py-12">
            ...
            <h4 class="text-lg font-semibold text-gray-900 mb-2">No Videos</h4>
            <p class="text-sm text-gray-500 mb-4">Get started by adding your first video.</p>
            <a href="{{url('/')}}/manager/dashboard/addVideo" class="admin-btn admin-btn-primary">
...
function deleteVideo(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{url('/')}}/manager/dashboard/deleteVideoAjax",
