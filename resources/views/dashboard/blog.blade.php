        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="page-back"><a href="{{url('/')}}/manager/dashboard/addBlog"><i class="fa fa-pencil" aria-hidden="true"></i> Add Blog Post</a>
                    </li>
                </ul>
            </div>
            <div class="sb2-2-1">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('/')}}/manager/dashboard/editBlog/{{$item->id}}" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            </td>
...
<script type="text/javascript">
    ...
    $('#categoryAddForm').on('submit',function(event){
        ...
        $.ajax({
          url: "{{url('/')}}/manager/dashboard/addCategoryAjaxRequest",
          type:"POST",
          data:{
            "_token": "{{ csrf_token() }}",
            title:title,
